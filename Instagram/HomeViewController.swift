...
//  Instagram
//
//  Created by 小尾真太郎 on 2016/12/04.
...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //コメント送信ボタンを押したときに、コメントをデータベースに保存！
        cell.comentSubmitButton.addTarget(self, action:#selector(SubmitButton(sender:event:)), for:  UIControlEvents.touchUpInside)
    ...
    func SubmitButton(sender: AnyObject, event:UIEvent) {
        print("DEBUG_PRINT: submitボタンがタップされました。")
